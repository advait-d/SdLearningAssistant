...
from app.api.routes import chat_router, health_router, admin_router, interview_router, resume_router, negotiation_router, roadmap_router, drills_router, whiteboard_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(whiteboard_router, prefix="/api/v1")     # POST /api/v1/whiteboard/grade
